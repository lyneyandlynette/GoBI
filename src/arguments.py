...
parser.add_argument('--count_reward_coef', default=0., type=float)
...
parser.add_argument('--simu_step', default=1, type=int)
parser.add_argument('--intrinsic_decay', default=0.00001, type=float)
